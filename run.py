...
Tasks = [
    ...
    # "Ze strony gofin.pl przygotuj symbole PKWiU i Nazwy oprogramowania dla uslugi zwiazanych z oprogramowaniem i stawkami VAT - zapisz dane w excelu.",
    # "Collect info about Polish customs duty fees for electric bikes; save report and also collected data into csv.",
    # "Collect info about board of directors of tesla and private information about each Director; save report and also collected data into csv.",
    "Go to https://www.google.com/recaptcha/api2/demo , solve capcha and finish. Dont save report or excel.",
    # "Go to https://2captcha.com/pl/demo/recaptcha-v2 , solve capcha and finish. Dont save report or excel.",
    # "Login to x.com",
]
for task in Tasks: 0
bool_plan = False
...
agents_tool = [agent_browser, agent_researcher] #filter here
#agents_tool = [agent_researcher] #filter here
agents_const = [agent_planner, agent_secretary]
agents_chat = agents_const + agents_tool
agents_transitions = {
    agent_planner: [agent_browser, agent_researcher, agent_secretary],
    agent_browser: [agent_secretary],
