...
Tasks = [
    ...
    "Go to https://2captcha.com/pl/demo/recaptcha-v2 and solve capcha.",
]
for task in Tasks: 0
bool_plan = False
...
Plan = [
    ...
    # "Collect info about board of directors of tesla and private information about each Director; save report and also collected data into csv.",
    # "Login to x.com and post something interesting.",
    "Collect most recent news on BTC",
    "Login to x.com",
    "Post a very brief message what is happening to BTC right now.",
]
task = '; '.join(Plan)
...
agents_transitions = {
    agent_planner: [agent_browser, agent_researcher],
